...
g.add((RUTA.tieneVelocidadMaxima,RDFS.range,XSD.float))
...
g.add((RUTA.tiempoEspera,RDFS.range,XSD.float))
...
g.add((RUTA.Duracion,RDFS.range,XSD.float))
...
g.add((RUTA.ObraVial,RUTA.Duracion,Literal(360)))
...
g.add((RUTA.AccidenteGrave,RUTA.Duracion,Literal(30)))
...
g.add((RUTA.ObraMenor,RUTA.Duracion,Literal(360)))
...
g.add((RUTA.AccidenteLeve,RUTA.Duracion,Literal(30)))
...
g.add((RUTA.Manifestacion,RUTA.Duracion,Literal(120)))
...
g.add((RUTA.VehiculoDetenido,RUTA.Duracion,Literal(10)))
...
g.add((RUTA.ColapsoEstructural,RUTA.Duracion,Literal(10080)))
...
g.add((RUTA.AutopistaSur,RUTA.tieneVelocidadMaxima,Literal(80)))
...
g.add((RUTA.AvenidaColombia,RUTA.tieneVelocidadMaxima,Literal(50)))
...
g.add((RUTA.Transversal51a,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Transversal53A,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Transversal53B,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Diagonal63B,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle55,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle48,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle51,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle48D,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle49A,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle49B,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle53,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Calle52,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera65,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera66,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera67,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera73,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera74,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera67B,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.BulevarLibertadores,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera68,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera64,RUTA.tieneVelocidadMaxima,Literal(30)))
...
g.add((RUTA.Carrera64B,RUTA.tieneVelocidadMaxima,Literal(30)))
...
def agregar_semaforo(via, tiempo):
    ...
    g.add((semaforo, RUTA.tiempoEspera, Literal(tiempo, datatype=XSD.float)))
...
def crear_ruta(vias, distancia, tiempo):
    ...
    g.add((ruta, RUTA.tieneDistancia, Literal(distancia, datatype=XSD.float)))
    g.add((ruta, RUTA.tiempoEstimado, Literal(tiempo, datatype=XSD.float)))
