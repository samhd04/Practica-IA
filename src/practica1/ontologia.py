...
agregar_semaforo(RUTA.AvenidaColombia)
agregar_semaforo(RUTA.Transversal51a)
agregar_semaforo(RUTA.Calle55)
agregar_semaforo(RUTA.Calle48)
agregar_semaforo(RUTA.Calle51)
agregar_semaforo(RUTA.Calle48D)
agregar_semaforo(RUTA.Calle49B)
agregar_semaforo(RUTA.Calle53)
agregar_semaforo(RUTA.Carrera65)
agregar_semaforo(RUTA.Carrera66)
agregar_semaforo(RUTA.Carrera67)
agregar_semaforo(RUTA.Carrera73)
agregar_semaforo(RUTA.Carrera74)
agregar_semaforo(RUTA.BulevarLibertadores)
agregar_semaforo(RUTA.Carrera68)
agregar_semaforo(RUTA.Carrera64)
agregar_semaforo(RUTA.Carrera64B)
...
print(f"Se encontraron {len(rutas_totales)}:\n")
